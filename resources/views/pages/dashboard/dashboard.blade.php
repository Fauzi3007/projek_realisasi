            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gapy-2 px-3">
                <form action="{{ route('filter') }}" method="POST">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <input type="number" id="filterId" class="border form-input border-gray-300 rounded-md px-4 py-2" name="filterValue" placeholder="%" min="0" max="100" step="0.05">
                        ...
                        <div class="relative">
                          <input class="datepicker form-input pl-9 dark:bg-slate-800 text-slate-500 hover:text-slate-600 dark:text-slate-300 dark:hover:text-slate-200 font-medium w-[15.5rem]"
                           placeholder="Pilih Tanggal" name="tanggalLaporan" data-class="flatpickr-left" />
                      ...
                      <div class="relative inline-block text-left">
                        <div>
                          <span class="rounded-md shadow-sm">
                            <button type="button" class="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-sm leading-5 font-medium text-slate-500 hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800 transition ease-in-out duration-150" id="dropdown-menu" aria-haspopup="true" aria-expanded="false">
                              Pilih Daerah
                      ...
                      <button type="submit" class="px-4 py-2 rounded-md bg-blue-500 text-white">Filter</button>
                    </div>
                </form>
            </div>
